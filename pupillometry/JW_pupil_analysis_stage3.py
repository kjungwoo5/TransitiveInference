...
def plot_by_session(aligned_pupil_by_session: dict, show_distribution: bool = False):
    for session, value in aligned_pupil_by_session.items():
        ...
        pupil_plot[0].show()
        fig.savefig(
            fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Individual Sessions\{session}.png')
        ...
        if show_distribution:
            ...
            dist_plot[0].show()
            fig.savefig(
                fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Actual Distributions\{session}_distribution.png'
            )
...
if SHOW_DISTRIBUTION:
    ...
    dist_plot[0].show()
    fig.savefig(
        fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Actual Distributions\{animals_to_list}_distribution.png'
    )
...
if PLOT_BY_SESSION:
    plot_by_session(aligned_pupil_by_session, SHOW_DISTRIBUTION)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Baseline_Subtracted.png')
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Baseline_Subtracted_Training.png')
plt.pause(0.1)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Baseline_Subtracted_Testing.png')
plt.pause(0.1)
...
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Coeff_Contribution.png')
...
fig = plt.gcf()
base_r2_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Coeff_R2.png')
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Baseline_Regressed_Training.png')
plt.pause(0.1)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Baseline_Regressed_Testing.png')
plt.pause(0.1)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\Stage 3 Baseline Regression\{animals_to_list}\{animals_to_list}_Baseline_Regressed.png')
plt.pause(0.1)