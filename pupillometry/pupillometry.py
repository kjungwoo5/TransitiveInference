...
def align_pupil_by_session(pupil_df: pd.DataFrame, harp_df: pd.DataFrame, stage: int, type_of_analysis: str = 'testing'):
...
def plot_baseline_sub_aligned_pupil_by_session(aligned_pupil_by_session: dict, output_path: Path, types_of_stimuli: list, type_of_analysis: str = 'testing'):
...
def plot_distribution_by_session(aligned_pupil_by_session: dict, output_path: Path, types_of_stimuli: list, type_of_analysis: str = 'testing'):
...
def aggregate_total(aligned_pupil_by_session: dict, types_of_stimuli: list) -> dict:
    total_responses = {}
    for stimulus in types_of_stimuli:
        aggregate = []
...
def plot_overall_baseline_sub_aligned_pupil(aligned_pupil_by_session: dict, output_path: Path, types_of_stimuli: list, animals: list, type_of_analysis: str = 'testing'):
