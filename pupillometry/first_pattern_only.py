...
ANIMALS_TO_DROP = ['JK01', 'JK02', 'JK03']

SESSIONS_TO_DROP = [
    'JK04_260427', 'JK04_260428', 'JK04_260429'
    ]

FIRST_PATTERN_ONLY = True
...
def plot_by_session(aligned_pupil_by_session: dict, show_distribution: bool = False):
    for session, value in aligned_pupil_by_session.items():
        ...
        pupil_plot[0].show()
        fig.savefig(
            fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\Individual Sessions\First_Pattern_{session}.png')
        ...
        if show_distribution:
            ...
            dist_plot[0].show()
            fig.savefig(
                fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\Actual Distributions\{session}_distribution.png'
            )
...
for session_id in session_ids:
    ...
    if not FIRST_PATTERN_ONLY:
        ...
        CDEFs = harp.index[
            (harp['Payload'] == 12) & (harp['Payload'].shift(-2) == 16) & (harp['Payload'].shift(1) == 30)].tolist()
...
if SHOW_DISTRIBUTION:
    ...
    dist_plot[0].show()
    fig.savefig(
        fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\Actual Distributions\{animals_to_list}_distribution.png'
    )
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Baseline_Subtracted.png')
...
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Coeff_Contribution.png')
...
fig = plt.gcf()
base_r2_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Coeff_R2.png')
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Baseline_Regressed_Training.png')
plt.pause(0.1)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Baseline_Regressed_Testing.png')
plt.pause(0.1)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Baseline_Regressed.png')
plt.pause(0.1)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Baseline_Subtracted_Training.png')
plt.pause(0.1)
...
fig = plt.gcf()
pupil_plot[0].show()
fig.savefig(fr'C:\Users\kjung\Documents\UCL\Year 4\ANAT0021 Dissertation\Coding\Analysis\Outputs\First Patterns Only\{animals_to_list}\{animals_to_list}_Baseline_Subtracted_Testing.png')
plt.pause(0.1)